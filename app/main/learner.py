...
#                         [target for target in task.targets if target.is_done])
#                     percent_completion = (
#                         completed_targets / no_of_targets) * 100
...
#                 else:
#                     tasks_progress = self.get_course_progress(
#                         user_id, current_course)
#                     is_task_complete = [
#                         x for x in tasks_progress if x.get(task_id) == 100]
#                     if is_task_complete:
